...
A compiled static website documenting the chronology of **CELAM** as an institution — the interpretation disputes live in cronologia/tl.
...
Beyond the family's five core rules: keep the institutional/theological
boundary (interpretation disputes belong to tl); record date disagreements
(1955 approval, early presidencies) instead of resolving them; prefer
gcatholic + Vatican News over DHIAL for officer lists (DHIAL is defective);
characterize CELAM's authority only in its statutes' own words.
