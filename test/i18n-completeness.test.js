...
const PUBLISHER_BRACKET_OK = new Set([
  // "(EN)" / "(ES)" name the language EDITION of Wikipedia — the parenthetical
  // names which encyclopedia, it does not characterise it.
  'wikipedia-en', 'wikipedia-es', 'wikipedia-cal', 'wikipedia-clar',
  // "(vatican.va)" names the publishing domain of the Holy See — the
  // parenthetical names the source, it does not characterise it.
  'vatican-bogota', 'vatican-puebla', 'vatican-santodomingo', 'vatican-aparecida',
]);
// <<< ADOPT
